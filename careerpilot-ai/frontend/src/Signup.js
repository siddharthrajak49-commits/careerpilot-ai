...
function Signup() {
  ...
  const sendOTP = async () => {
    ...
    try {
      ...
      const res = await api("/send-signup-otp", "POST", { email });
  ...
  const verifyOTP = async () => {
    ...
    try {
      ...
      const res = await api("/verify-signup-otp", "POST", {
        name,
        email,
        password,
        otp,
  ...
  return (
    <div className="container">
      <div className="card authCard">
        ...
        <p className="subtitle">Join CareerPilot & Boost Your Career Journey</p>
